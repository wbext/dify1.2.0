...
import Button from '@/app/components/base/button'; //导入按钮
...
const ChatInputArea = ({
  ...
  // 在组件内部，放在其他useState附近
  const { i18n } = useTranslation();
  const isChineseLanguage = i18n.language === 'zh-Hans' || i18n.language === 'zh-Hant';
  // 定义按钮点击事件
  const handleButtonClick = () => {
    window.open('https://p30qp6.laf.run/click/trackClick_udesk', '_blank');
  };
  return (
    <>
      <div
